...
const JP_CARDS_CACHE_VERSION = 'jp-cards:v13';
              ...
              try {
                ...
                cards = mergedCards.map(c => {
                  ...
                  const tcgpCdnImg = c.productId
                    ...
                    : null;
                  // SV JP: TCGplayer CDN 400w is consistent quality with no card backs
                  // ME JP: Scrydex has verified real art
                  const isSVJP = setId.startsWith('sv');
                  const image = isSVJP
                    ? (tcgpCdnImg || scrydexImg || tcgcsvImg || null)

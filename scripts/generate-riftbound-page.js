...
@media(max-width:640px){
  ...
  .section-nav-btn,.section-nav-sets-btn{padding:10px 4px;font-size:.65rem;letter-spacing:0;flex:1;text-align:center;white-space:nowrap}
  .section-nav-sets{flex:1;flex-shrink:1}

...
const SEO_DATA = {
  ...
  'vnd': {
    ...
    faq: [
      ...
      { q: 'When did Riftbound Vendetta release?', a: 'Vendetta released July 31, 2026 as the first Riftbound set to launch simultaneously in English and Simplified Chinese, removing the months-long regional gap that affected Origins and Spiritforged. French-language cards are planned for October 23, 2026.' },

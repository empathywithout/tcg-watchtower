...
.buy-tcgp{background:rgba(45,212,191,.15);border:1px solid rgba(45,212,191,.3);color:var(--teal);font-size:.5rem}
...
<section class="section">
  <div class="container" style="text-align:center">
    ...
    <a href="https://discord.gg/cZxJV9YRyb" class="btn-discord-cta" style="display:inline-flex;align-items:center;gap:8px;font-size:1rem;padding:12px 28px;background:linear-gradient(135deg,rgba(45,212,191,0.8),rgba(13,148,136,0.8));border:1px solid rgba(45,212,191,0.5);color:#020f0d;border-radius:8px;text-decoration:none;font-weight:700;transition:all 0.2s;box-shadow:0 4px 15px rgba(45,212,191,0.3)">
  ...
  document.getElementById('modal-inner').innerHTML = \`
    ...
    <div>
      ...
      <div class="modal-links">
        ...
        <a class="modal-buy-link" href="\${cardPageUrl(localId, card.name, card.rarity)}" style="background:rgba(45,212,191,0.08);border:1px solid var(--teal-border);color:var(--teal)">View Full Card Page <span>→</span></a>
      </div>
    </div>\`;

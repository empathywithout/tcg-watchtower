...
@media(max-width:640px){
  ...
  .section-nav-btn,.section-nav-sets-btn,.section-nav-sets{flex:1 1 0!important;min-width:0;padding:10px 2px;font-size:.65rem;letter-spacing:0;text-align:center;white-space:nowrap}

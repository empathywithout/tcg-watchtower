...
const SEO_DATA = {
  ...
  'me05': {
    metaTitle: 'Pitch Black Card List: 120 Cards, Rarity Filter & Prices | TCG Watchtower',
    metaDesc: 'Complete Pitch Black card list — all 120 English cards with live prices, chase cards ranked by current market price, and rarity filter. Released July 17, 2026.',
    intro: 'Pitch Black is the fifth set in the Pokemon TCG Mega Evolution series, released July 17, 2026. Based on the Japanese Abyss Eye set, ME5 is headlined by Mega Darkrai ex as the top chase pull alongside Mega Zeraora ex, Mega Chandelure ex, and Mega Excadrill ex. Browse the complete 120-card English set below, with live prices from TCGplayer.',
    faq: [
      ...
      { q: 'How many cards are in the Pitch Black card list?', a: 'Pitch Black contains 120 cards — 84 base set cards plus 36 secret rares including Illustration Rares, Special Illustration Rares, and the Mega Darkrai ex Hyper Rare at #120.' },
      { q: 'When does Pitch Black release?', a: 'Pitch Black released July 17, 2026. Prerelease events ran July 4–13, 2026 at participating local game stores.' },
      { q: 'What Mega Pokemon are in Pitch Black?', a: 'Pitch Black features six Mega Evolution Pokémon ex: Mega Darkrai ex, Mega Zeraora ex, Mega Chandelure ex, Mega Excadrill ex, Mega Delphox ex, and Mega Slowbro ex.' },
...
const SET_PAGE_JS  = readFileSync('static/set-page.js',  'utf8').trim()
  .replaceAll('{{JP_SOURCE_SET_ID}}', PHASE === 'jp' ? (JP_SCRYDEX_ID || SET_ID) : SET_ID);

...
const SEO_DATA = {
  ...
  'sv1s_ja': {
    ...
    intro: `Scarlet ex (SV1S) is the first Japanese expansion of the Scarlet & Violet era, released January 20, 2023 alongside its companion set <a href="/pokemon/sets/scarlet-violet-jp/violet-ex/cards" style="color:var(--accent);">Violet ex (SV1V)</a>. Together the two sets introduced the ex mechanic and Terastal forms to the modern Pokémon TCG. Scarlet ex contains 108 cards and is the Japanese source for the English <a href="/pokemon/sets/scarlet-violet/base-set/cards" style="color:var(--accent);">Scarlet & Violet Base Set (SV1)</a>. The top chase card is Gardevoir ex SAR (#101), one of the most iconic Special Art Rares of the generation. This complete Scarlet ex card list covers all 108 JP cards with English name translations, rarity filters, and live prices on TCG Watchtower.`,
    faq: [

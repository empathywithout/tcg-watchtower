...
<script>window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments);}gtag('js',new Date());gtag('set',{set_id:'${data.setSlug}',page_type:'sealed_product'});gtag('config','G-E0S4363S5Y');</script>

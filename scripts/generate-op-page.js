...
function cardPageUrl(localId, rawName) {
  ...
  return \`/one-piece/sets/\${SET_URL_SLUG}/cards/\${toSlug(rawName)}-\${toSlug(dispNum)}\`;
}
  ...
  document.getElementById('modal-inner').innerHTML=\`
    ...
    <div>
      ...
      <div class="modal-links">
        <a class="modal-buy-link pl-amazon" href="\${amazonLink(name+' '+dispNum+' '+SET_FULL_NAME+' One Piece Card')}" target="_blank" rel="noopener"><span>🛒 Find on Amazon</span><span>→</span></a>

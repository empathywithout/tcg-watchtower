...
.bg-grid{position:fixed;inset:0;background-image:linear-gradient(rgba(239,68,68,.03) 1px,transparent 1px),linear-gradient(90deg,rgba(239,68,68,.03) 1px,transparent 1px);background-size:50px 50px;pointer-events:none;z-index:0}
.orb{position:fixed;border-radius:50%;filter:blur(80px);pointer-events:none;z-index:0}
.orb-1{width:600px;height:600px;background:rgba(239,68,68,.06);top:-200px;right:-200px}
.orb-2{width:400px;height:400px;background:rgba(168,85,247,.05);bottom:-100px;left:-100px}
...
.section-nav-dropdown{display:none;position:absolute;right:0;top:100%;background:#1e293b;border:1px solid rgba(255,255,255,.12);border-radius:12px;min-width:240px;max-height:60vh;overflow-y:auto;z-index:3000;box-shadow:0 16px 48px rgba(0,0,0,.8);padding:8px;margin-top:4px}

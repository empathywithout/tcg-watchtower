...
<nav class="section-nav" id="section-nav">
  <div class="section-nav-inner">
    ...
    <button class="section-nav-btn" data-target="section-chase" data-url="/one-piece/sets/${SET_URL_SLUG}/top-chase-cards">Chase Cards</button>
    <button class="section-nav-btn active" data-target="section-cards" data-url="/one-piece/sets/${SET_URL_SLUG}/cards">Card List</button>
    <button class="section-nav-btn" data-target="section-products" data-url="/one-piece/sets/${SET_URL_SLUG}/sealed-product">Sealed Products</button>

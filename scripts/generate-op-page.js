...
/* Section Nav */
.section-nav{position:sticky;top:64px;z-index:1000;background:rgba(10,5,20,.95);backdrop-filter:blur(12px);border-bottom:1px solid rgba(255,255,255,.08)}
...
fetch('/nav.html').then(r => r.text()).then(html => {
  ...
  temp.innerHTML = html;
  // Wrap only the <nav> element in .nav-wrapper; insert other elements (overlays, menus) bare

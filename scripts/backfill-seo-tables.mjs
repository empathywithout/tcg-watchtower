...
const PULL_RATES = {
  ...
  me04: {
    name: 'Chaos Rising', source: 'TCGplayer Authentication Center (8,500+ packs)',
  ...
  me03: {
    name: 'Perfect Order', source: 'TCGplayer Authentication Center (3,500+ packs)',
  ...
  sv8pt5: {
    name: 'Prismatic Evolutions', source: 'TCGplayer Authentication Center (1,200+ packs)',
    sourceUrl: 'https://www.tcgplayer.com/content/article/Pok%C3%A9mon-TCG-Prismatic-Evolutions-Pull-Rates/d94889ea-f76a-4a13-b74d-5b0b071220a7/',
    rates: [
      { rarity: 'Double Rare',               short: 'DR',  pct: '~20%',  overall: '1 in 5',   specific: '1 in 49'   },
      { rarity: 'Ultra Rare',                short: 'UR',  pct: '~8%',   overall: '1 in 12',  specific: '1 in 217'  },
      { rarity: 'Special Illustration Rare', short: 'SIR', pct: '~2.2%', overall: '1 in 45',  specific: '1 in 1440' },
      { rarity: 'Hyper Rare',                short: 'HR',  pct: '~0.8%', overall: '1 in 125', specific: '1 in 125',  chase: true },
    ],
  ...
  sv07: {
    ...
    rates: [
      { rarity: 'Double Rare',               short: 'DR',  pct: '~20%',  overall: '1 in 5',   specific: '1 in 49'   },
      { rarity: 'Illustration Rare',         short: 'IR',  pct: '~8%',   overall: '1 in 13',  specific: '1 in 101'  },
      { rarity: 'Ultra Rare',                short: 'UR',  pct: '~8%',   overall: '1 in 12',  specific: '1 in 204'  },
      { rarity: 'Special Illustration Rare', short: 'SIR', pct: '~1%',   overall: '1 in 100', specific: '1 in 600'  },
      { rarity: 'Hyper Rare',                short: 'HR',  pct: '~0.19%',overall: '1 in 526', specific: '1 in 526',  chase: true },
    ],
  ...
  sv6pt5: {
    ...
    rates: [
      ...
      { rarity: 'Illustration Rare',         short: 'IR',  pct: '~11%',  overall: '1 in 9',   specific: '1 in 103'  },
      { rarity: 'Ultra Rare',                short: 'UR',  pct: '~8%',   overall: '1 in 12',  specific: '1 in 204'  },
      { rarity: 'Special Illustration Rare', short: 'SIR', pct: '~1.2%', overall: '1 in 83',  specific: '1 in 332'  },
      { rarity: 'Hyper Rare',                short: 'HR',  pct: '~0.1%', overall: '1 in 956', specific: '1 in 956',  chase: true },
    ],
    boxNote: 'Shrouded Fable is a mini-set. Smaller card count means better per-card odds for most rarities.',
  },
  sv05: {
    name: 'Temporal Forces', source: 'TCGplayer Authentication Center (8,000+ packs)',
    sourceUrl: 'https://www.tcgplayer.com/content/article/Pok%C3%A9mon-TCG-Temporal-Forces-Pull-Rates/28c0ad22-00a4-428f-b22d-e7fee9ec50bc/',
    rates: [
      { rarity: 'Double Rare',               short: 'DR',  pct: '~20%',  overall: '1 in 5',   specific: '1 in 49'   },
      { rarity: 'Illustration Rare',         short: 'IR',  pct: '~11%',  overall: '1 in 9',   specific: '1 in 103'  },
      { rarity: 'Ultra Rare',                short: 'UR',  pct: '~8%',   overall: '1 in 12',  specific: '1 in 217'  },
      { rarity: 'Special Illustration Rare', short: 'SIR', pct: '~1%',   overall: '1 in 100', specific: '1 in 1000' },
      { rarity: 'Hyper Rare',                short: 'HR',  pct: '~0.7%', overall: '1 in 143', specific: '1 in 858',  chase: true },
    ],
    boxNote: 'ACE SPEC cards appear in ~5% of packs. Expect roughly 1 SIR per 3 booster boxes.',
  },
  sv04: {
    name: 'Paradox Rift', source: 'TCGplayer Authentication Center (8,000+ packs)',
    sourceUrl: 'https://www.tcgplayer.com/content/article/Pok%C3%A9mon-TCG-Paradox-Rift-Pull-Rates/0b5fb648-38fc-4f61-a6af-57c2737b4a48/',
    rates: [
      { rarity: 'Double Rare',               short: 'DR',  pct: '~20%',  overall: '1 in 5',   specific: '1 in 49'   },
      { rarity: 'Illustration Rare',         short: 'IR',  pct: '~11%',  overall: '1 in 9',   specific: '1 in 103'  },
      { rarity: 'Ultra Rare',                short: 'UR',  pct: '~8%',   overall: '1 in 12',  specific: '1 in 217'  },
  ...
  sv4pt5: {
    ...
    rates: [
      { rarity: 'Double Rare',               short: 'DR',  pct: '~20%',  overall: '1 in 5',   specific: '1 in 49'   },
      { rarity: 'Ultra Rare',                short: 'UR',  pct: '~8%',   overall: '1 in 12',  specific: '1 in 217'  },
      { rarity: 'Special Illustration Rare', short: 'SIR', pct: '~2%',   overall: '1 in 50',  specific: '1 in 415'  },
      { rarity: 'Hyper Rare',                short: 'HR',  pct: '~0.1%', overall: '1 in 956', specific: '1 in 956',  chase: true },
    ],
...
// ── Sealed Products nav button (page already has the section, just missing the nav link) ──
function injectOPProductsNavButton(html, urlSlug) {
  if (html.includes('data-target="section-products"')) return html;
  const cardListBtn = /<button class="section-nav-btn active" data-target="section-cards" data-url="[^"]*"><span class="nav-full">Card List<\/span><span class="nav-short">Cards<\/span><\/button>/;
  const navBtn = `<button class="section-nav-btn active" data-target="section-cards" data-url="/one-piece/sets/${urlSlug}/cards"><span class="nav-full">Card List</span><span class="nav-short">Cards</span></button>\n    <button class="section-nav-btn" data-target="section-products" data-url="/one-piece/sets/${urlSlug}/sealed-product"><span class="nav-full">Sealed Products</span><span class="nav-short">Sealed</span></button>`;
  if (!cardListBtn.test(html)) return html;
  return html.replace(cardListBtn, navBtn);
}

// ── Restock Alerts / Discord CTA section (missing entirely on existing OP pages) ──
function injectOPRestockAlerts(html, name, short) {
  if (html.includes('Restock Alerts')) return html;
  const section = `
<!-- ===== DISCORD CTA ===== -->
<section class="section">
  <div class="container" style="text-align:center">
    ...
    <p style="color:var(--muted);max-width:560px;margin:0 auto 36px">
      Join 2,800+ collectors on Discord and get instant notifications when ${short} Booster Boxes, ETBs, and sealed product goes live at major retailers.
    </p>
...
for (const { setId, file, urlSlug, name, short, releaseDate, totalCards } of OP_SETS) {
  ...
  // 7b. Sealed Products nav button
  const htmlBeforeNav = html;
  html = injectOPProductsNavButton(html, urlSlug);
  if (html !== htmlBeforeNav) changes.push('products nav button');

  // 7c. Restock Alerts / Discord CTA section
  const htmlBeforeRestock = html;
  html = injectOPRestockAlerts(html, name, short);
  if (html !== htmlBeforeRestock) changes.push('restock alerts');

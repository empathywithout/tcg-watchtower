...
const SET_FAQS = {
  ...
  'sv05': [
    { q: 'What is the most expensive Temporal Forces card?', a: "The most expensive Temporal Forces card is the Iron Crown ex Special Illustration Rare (#203), which has climbed to become the standout chase pull of the set. Walking Wake ex SIR (#205) and Gouging Fire ex SIR (#204) are also top pulls. ACE SPEC cards like Prime Catcher are competitively valuable but not the most expensive singles. Check live prices on TCG Watchtower." },

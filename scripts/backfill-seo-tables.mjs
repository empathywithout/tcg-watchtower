...
const SET_FAQS = {
  ...
  'me04': [
    { q: 'What is the most expensive Chaos Rising card?', a: 'The most expensive Chaos Rising cards are the Mega Greninja ex Mega Hyper Rare (#122) and the Mega Greninja ex Special Illustration Rare. Mega Greninja ex is the standout chase pull and most anticipated card in the set.' },
    ...
    { q: 'When did Chaos Rising release?', a: 'Chaos Rising released May 22, 2026 as the fourth set in the Pokémon TCG Mega Evolution series. Prerelease events ran May 9–17, 2026.' },
    { q: 'What Mega Pokemon are in Chaos Rising?', a: 'Chaos Rising features five Mega Evolution Pokémon ex: Mega Greninja ex (the headline card), Mega Floette ex, Mega Pyroar ex, Mega Dragalge ex, and Mega Gallade ex — with Mega Gallade ex added exclusively to the English set.' },
  ...
  'me02pt5': [
    ...
    { q: 'How many cards are in the Ascended Heroes card list?', a: 'Ascended Heroes contains 295 cards in total, making it the largest Pokémon TCG set ever printed. The set has a high concentration of Special Illustration Rares relative to set size.' },
    { q: 'When did Ascended Heroes release?', a: 'Ascended Heroes released January 2026 as the ME2.5 subset expansion in the Pokémon TCG Mega Evolution series.' },
    ...
    { q: 'Is Ascended Heroes worth buying?', a: 'Ascended Heroes has a high concentration of premium rarities relative to its set size, with 295 cards and a deep SIR lineup. Collectors targeting the Mega Gengar ex SIR make it a consistent target for sealed product purchases.' },
  ],
  'sv01': [
...
const SET_INTROS = {
  'sv01': 'Scarlet &amp; Violet Base Set is the first expansion of the Pokémon TCG Scarlet &amp; Violet era, released March 31, 2023. Based on Japan's Scarlet ex and Violet ex sets, it introduced Pokémon ex, Illustration Rares, and Special Illustration Rares as new chase rarities. The 258-card set is headlined by Charizard ex SIR and Miraidon ex SIR as the top chase pulls, alongside Koraidon ex and a deep roster of full-art Trainer SIRs. This complete Scarlet &amp; Violet Base Set card list includes every card with rarity filters and live TCGplayer prices updated daily.',
  ...
  'sv05': 'Temporal Forces is the fifth Scarlet &amp; Violet expansion, released March 22, 2024. Based on Japan's Temporal Forces set, it reintroduced ACE SPEC cards to the Pokémon TCG for the first time since the Black &amp; White era. Walking Wake ex SIR and Iron Leaves ex SIR are the headline Pokémon pulls, while ACE SPEC Trainer cards like Counter Catcher and Unfair Stamp are among the most competitively impactful cards. The 218-card set spans 162 main cards plus 56 secret rares. This complete Temporal Forces card list includes every card with rarity filters and live TCGplayer prices updated daily.',
  'sv06': 'Twilight Masquerade is the sixth Scarlet &amp; Violet expansion, released May 24, 2024. Based on Japan's Mask of Change set, it is built around Ogerpon ex in all four mask forms. The Wellspring Mask Ogerpon ex SIR — illustrated with flowing water and pale moonlight — is the top chase pull and one of the most visually striking SIRs of the era. The 226-card set spans 162 main set cards plus 64 secret rares. This complete Twilight Masquerade card list includes every card with rarity filters and live TCGplayer prices updated daily.',
  'sv6pt5': 'Shrouded Fable is the third Scarlet &amp; Violet subset, released August 2, 2024. Based on Japan's Transformation Mask set, it focuses on the Mask of Ruin legendaries — Chien-Pao ex, Ting-Lu ex, Chi-Yu ex, and Wo-Chien ex — alongside the mythical Pecharunt ex. At just 99 cards, it has a higher hit rate on premium rarities per pack than any standard main set. Pecharunt ex SIR and the Loyal Three SIRs are the top chase pulls. This complete Shrouded Fable card list includes every card with rarity filters and live TCGplayer prices updated daily.',
  'sv07': 'Stellar Crown is the seventh Scarlet &amp; Violet expansion, released September 13, 2024. Based on Japan's Stellar Miracle set, it introduced Stellar-type Tera Pokémon ex — a special rainbow type that can use any Energy — headlined by Terapagos ex. The 175-card set spans 142 main set cards plus 33 secret rares, with Terapagos ex SIR as the top chase pull. This complete Stellar Crown card list includes every card with rarity filters and live TCGplayer prices updated daily.',

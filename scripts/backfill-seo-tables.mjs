...
const SET_FAQS = {
  ...
  'me02pt5': [
    ...
    { q: 'Is Ascended Heroes worth buying?', a: "Ascended Heroes has a high concentration of premium rarities relative to its set size. Collectors targeting the Mega Gengar ex SIR make it a consistent target for sealed product purchases." },
  ],
  'sv01': [
    { q: 'What is the most expensive Scarlet & Violet Base Set card?', a: "The most expensive Scarlet & Violet Base Set cards are the Charizard ex SIR and Miraidon ex SIR. Charizard ex consistently ranks as one of the top market value cards in the Scarlet & Violet era." },
    { q: 'How many cards are in the Scarlet & Violet Base Set card list?', a: "Scarlet & Violet Base Set contains 258 cards — 198 main set cards plus 60 secret rares including Illustration Rares and Special Illustration Rares." },
  ...
  'sv04': [
    { q: 'What is the most expensive Paradox Rift card?', a: "The most expensive Paradox Rift cards are the Roaring Moon ex SIR and Iron Valiant ex SIR — both competitively viable and visually striking chase pulls." },
  ...
  'sv4pt5': [
    { q: 'What is the most expensive Paldean Fates card?', a: "The most expensive Paldean Fates cards are the Shiny Charizard ex SIR and Shiny Gardevoir ex SIR. Shiny Charizard ex is the headline chase pull." },
  ...
  'sv05': [
    { q: 'What is the most expensive Temporal Forces card?', a: "The most expensive Temporal Forces cards are ACE SPEC Trainer cards like Counter Catcher and Unfair Stamp, alongside Walking Wake ex SIR and Iron Leaves ex SIR as the top Pokemon pulls." },
  ...
  'sv06': [
    { q: 'What is the most expensive Twilight Masquerade card?', a: "The most expensive Twilight Masquerade card is the Wellspring Mask Ogerpon ex Special Illustration Rare, which is also competitively viable. The other Ogerpon ex SIR variants are also top pulls." },
  ...
  'sv6pt5': [
    { q: 'What is the most expensive Shrouded Fable card?', a: "The most expensive Shrouded Fable cards are the Pecharunt ex SIR and the Mask of Ruin legendary SIRs. Despite being a small 99-card set, it has strong SIR density." },
  ...
  'sv07': [
    { q: 'What is the most expensive Stellar Crown card?', a: "The most expensive Stellar Crown card is the Terapagos ex Special Illustration Rare. Terapagos ex is the headline chase pull as the first Stellar-type Pokemon ex." },
  ...
  'sv08': [
    { q: 'What is the most expensive Surging Sparks card?', a: "The most expensive Surging Sparks cards are the multiple Pikachu ex Special Illustration Rare variants. All Pikachu ex SIR variants command strong secondary market prices." },
...
<div class="download-buttons-section" style="margin:0 0 32px;padding:20px 24px;background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.07);border-radius:12px;">
  ...
  <div style="display:flex;flex-wrap:wrap;gap:10px;">
    <a href="/api/checklist?set=${setId}&type=master" download style="display:inline-flex;align-items:center;gap:8px;padding:9px 16px;background:rgba(74,222,128,0.1);border:1px solid rgba(74,222,128,0.25);border-radius:8px;color:#4ade80;font-size:0.82rem;font-weight:700;text-decoration:none;transition:all 0.2s;" onmouseover="this.style.background='rgba(74,222,128,0.2)'" onmouseout="this.style.background='rgba(74,222,128,0.1)'">
      <span>📋</span> Free Master Set Checklist
    </a>

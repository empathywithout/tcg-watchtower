...
const SET_FAQS = {
  ...
  'sv6pt5': [
    { q: 'What is the most expensive Shrouded Fable card?', a: "The most expensive Shrouded Fable cards are the Basic Darkness Energy Hyper Rare (#98), Duskull Illustration Rare (#68), Persian Illustration Rare (#78), and Cassiopeia SIR (#94). The Gen 1 nostalgia Illustration Rares and the Darkness Energy Hyper Rare consistently top the price charts." },
  ...
  'sv07': [
    { q: 'What is the most expensive Stellar Crown card?', a: "The most expensive Stellar Crown cards are the Squirtle Illustration Rare (#148) and Bulbasaur Illustration Rare (#143) — both Gen 1 starters commanding prices above $60-70. The Terapagos ex SIR (#170) and Dachsbun ex SIR (#169) are also top pulls." },
  ...
  'sv08': [
    { q: 'What is the most expensive Surging Sparks card?', a: "The most expensive Surging Sparks card is the Pikachu ex Special Illustration Rare (#238), which hit $500+ at launch and remains one of the most valuable cards of 2024. Latias ex SIR (#239) and Milotic ex SIR (#237) are the next highest pulls." },

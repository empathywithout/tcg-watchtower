...
const SET_FAQS = {
  ...
  'sv10': [
    { q: 'What is the most expensive Destined Rivals card?', a: "The most expensive Destined Rivals cards are the Special Illustration Rares featuring iconic rival duos. Check the Chase Cards section above for current live TCG Watchtower market values." },
...
<div class="download-buttons-section" style="margin:0 0 32px;padding:20px 24px;background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.07);border-radius:12px;">
  ...
  <div style="display:flex;flex-wrap:wrap;gap:10px;">
    <div style="display:flex;flex-direction:column;gap:6px;">
      <span style="font-size:0.72rem;font-weight:700;text-transform:uppercase;letter-spacing:0.06em;color:var(--text-muted);">📋 Free Master Set Checklist</span>
      <div style="display:flex;gap:6px;">
        <a href="/api/checklist?set=${setId}&type=master&format=xlsx" download style="display:inline-flex;align-items:center;gap:6px;padding:7px 13px;background:rgba(74,222,128,0.1);border:1px solid rgba(74,222,128,0.25);border-radius:8px;color:#4ade80;font-size:0.78rem;font-weight:700;text-decoration:none;transition:all 0.2s;" onmouseover="this.style.background='rgba(74,222,128,0.2)'" onmouseout="this.style.background='rgba(74,222,128,0.1)'" title="Opens in Google Sheets or Excel with dropdowns and color coding">
          <span>📊</span> Google Sheets / Excel
        </a>
        <a href="/api/checklist?set=${setId}&type=master&format=csv" download style="display:inline-flex;align-items:center;gap:6px;padding:7px 13px;background:rgba(74,222,128,0.06);border:1px solid rgba(74,222,128,0.15);border-radius:8px;color:#86efac;font-size:0.78rem;font-weight:600;text-decoration:none;transition:all 0.2s;" onmouseover="this.style.background='rgba(74,222,128,0.12)'" onmouseout="this.style.background='rgba(74,222,128,0.06)'" title="Plain CSV — works everywhere">
          <span>📄</span> CSV
        </a>
      </div>
    </div>
